...
class FabricacionDetalleConsumidoResult {
  const FabricacionDetalleConsumidoResult({
    required this.detalle,
    required this.reloadProductos,
  });

  final FabricacionDetalleConsumido detalle;
  final bool reloadProductos;
}

class FabricacionDetalleConsumidoFormView extends StatefulWidget {
  const FabricacionDetalleConsumidoFormView({
    super.key,
  ...
  @override
  State<FabricacionDetalleConsumidoFormView> createState() =>
      _FabricacionDetalleConsumidoFormViewState();
}

class _FabricacionDetalleConsumidoFormViewState
    extends State<FabricacionDetalleConsumidoFormView> {
  ...
  Future<void> _onSave() async {
    ...
    final FabricacionDetalleConsumido detalle = FabricacionDetalleConsumido(
    ...
    Navigator.pop(
      context,
      FabricacionDetalleConsumidoResult(
        detalle: detalle,
  ...
  Widget build(BuildContext context) {
    ...
    return FormPageScaffold(
      title: widget.detalle == null
          ? 'Agregar insumo consumido'
          : 'Editar insumo consumido',
      onSave: () => _onSave(),
